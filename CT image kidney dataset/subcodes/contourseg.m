...
function seg = contourseg(I,mask,num_iter,mu,method)
...
%           subplot(1,2,1); contour(flipud(phi0), [0 0], 'r','LineWidth',1); title('initial contour');
          subplot(1,2,1); 
        ...
        %-- Main loop
          for n=1:num_iter
              ...
              if indicator % decide to stop or continue 
                  ...
                  subplot(1,2,2); imshow(seg); title('Segmented Image');
...
%         subplot(1,2,1);
        ...
        title('initial contour');
        hold off
        subplot(1,2,1); title('Segmentation');
        ...
        for n=1:num_iter
              ...
              if indicator 
                 ...
                 subplot(1,2,2); imagesc(seg);axis image;title('Segmented Image');
